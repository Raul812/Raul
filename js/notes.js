  ...
  function loadArticle(id) {
    ...
    fetchJSON(INDEX_URL)
      .then(function (notes) {
        ...
        if (!note) {
          articleEl.innerHTML =
            '<div class="empty-note">没有找到这篇文章。<br><br><a class="text-link" href="notes.html">← 返回笔记列表</a></div>';
          return;
        }
      ...
      .catch(function (err) {
        articleEl.innerHTML =
          '<div class="empty-note">加载失败：' + escapeHtml(err.message) +
          '<br><br><a class="text-link" href="notes.html">← 返回笔记列表</a></div>';
      });
  }
